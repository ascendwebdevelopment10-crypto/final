...
async function generateEmail(contact, segment) {
      ...
      let prompt;
      if (service === 'website') {
              prompt = `Write a short cold email (under 150 words) to ${firstName} at ${company}${segment === 'no_website' ? ' who has no website' : ' in the ' + industry + ' industry'}. We are Ascend Web Development. We build SEO-optimized websites that bring in more Google traffic and make the business look credible and professional. Friendly, no fluff. Soft CTA to reply. Subject line first as "Subject: ...". Sign off as: Ascend Web Development. IMPORTANT: Do not use any placeholder text such as [Your Name], [Name], [Company], [Phone], [Link], or any text in brackets. Output only the subject line and email body, nothing else.`;
      } else if (service === 'ads') {
              prompt = `Write a short cold email (under 150 words) to ${firstName} at ${company} in the ${industry} industry. We are Ascend Web Development. We run Google and Meta ad campaigns that drive real paying customers. Mention ROI, targeting, and local reach. Friendly, no fluff. Soft CTA to reply. Subject line first as "Subject: ...". Sign off as: Ascend Web Development. IMPORTANT: Do not use any placeholder text such as [Your Name], [Name], [Company], [Phone], [Link], or any text in brackets. Output only the subject line and email body, nothing else.`;
      } else {
              prompt = `Write a short cold email (under 150 words) to ${firstName} at ${company} in the ${industry} industry. We are Ascend Web Development. We build custom mobile apps with online booking, loyalty rewards, and push notifications. Friendly, no fluff. Soft CTA to reply. Subject line first as "Subject: ...". Sign off as: Ascend Web Development. IMPORTANT: Do not use any placeholder text such as [Your Name], [Name], [Company], [Phone], [Link], or any text in brackets. Output only the subject line and email body, nothing else.`;
      }
...
async function generateSms(contact, segment) {
      ...
      let prompt;
      if (service === 'website') {
              prompt = `Write a single SMS message to ${firstName} at ${company}${segment === 'no_website' ? ' who has no website' : ' in the ' + industry + ' industry'}. We are Ascend Web Development. We build websites that get more Google traffic and customers. Include a CTA to reply. No emojis. Sign off as: - Ascend Web Development. IMPORTANT: Do not use any placeholder text such as [Your Name], [Name], [Phone], [Link], or any text in brackets. Output ONLY the raw SMS text, nothing else.`;
      } else if (service === 'ads') {
              prompt = `Write a single SMS message to ${firstName} at ${company} in the ${industry} industry. We are Ascend Web Development. We run Google and Meta ads that bring in paying customers. Include a CTA to reply. No emojis. Sign off as: - Ascend Web Development. IMPORTANT: Do not use any placeholder text such as [Your Name], [Name], [Phone], [Link], or any text in brackets. Output ONLY the raw SMS text, nothing else.`;
      } else {
              prompt = `Write a single SMS message to ${firstName} at ${company} in the ${industry} industry. We are Ascend Web Development. We build custom mobile apps with booking, loyalty, and push notifications. Include a CTA to reply. No emojis. Sign off as: - Ascend Web Development. IMPORTANT: Do not use any placeholder text such as [Your Name], [Name], [Phone], [Link], or any text in brackets. Output ONLY the raw SMS text, nothing else.`;
      }
      const msg = await anthropic.messages.create({
      ...
      fullText = cleanPlaceholders(fullText);
