...
const POSTS = [
  {
    title: 'One workspace, less chaos',
    text: 'Five disconnected tools create five places for work to get lost. Nitro keeps your website, content, social, ads, and outreach in one workspace so the next move is always obvious.\n\nStart free: nitrooutreach.com\n\n#smallbusinessmarketing #marketingworkflow #nitrooutreach',
    mediaUrl: 'https://nitrooutreach.com/social/aug-2026/01-one-workspace.jpg',
  },
  {
    title: 'Your website should start conversations',
    text: 'A website should do more than exist. Build the page, see the visitor signal, and keep the follow-up moving from the same place.\n\nBuild yours with Nitro: nitrooutreach.com\n\n#businesswebsite #leadgeneration #smallbusiness',
    mediaUrl: 'https://nitrooutreach.com/social/aug-2026/02-website.jpg',
  },
  {
    title: 'Turn one idea into a week of content',
    text: 'One useful idea can become the hook, the post, the Reel, and the campaign. Nitro helps you keep the idea consistent without making every post feel copied.\n\n#contentmarketing #reelsstrategy #smallbusinesscontent',
    mediaUrl: 'https://nitrooutreach.com/social/aug-2026/03-content.jpg',
  },
  {
    title: 'Schedule it once',
    text: 'Your future self should not have to remember what needs posting tomorrow. Plan the week once, see it on the calendar, and let the queue handle the timing.\n\n#socialscheduler #contentcalendar #smallbusinessowner',
    mediaUrl: 'https://nitrooutreach.com/social/aug-2026/04-social.jpg',
  },
  {
    title: 'Follow the signal',
    text: 'Opened is curiosity. Clicked is intent. Replied is a conversation. Keep those signals together so the next follow-up is based on what actually happened.\n\n#outreach #salesfollowup #leadtracking',
    mediaUrl: 'https://nitrooutreach.com/social/aug-2026/05-outreach.jpg',
  },
  {
    title: 'Try one real job for free',
    text: '$0 to start. No card. No forced demo. Use Nitro for one real job today: build a page, make content, schedule posts, or organize outreach.\n\nnitrooutreach.com\n\n#entrepreneurtools #smallbusinessgrowth #nitrooutreach',
    mediaUrl: 'https://nitrooutreach.com/social/aug-2026/06-start-free.jpg',
  },
  {
    title: 'Marketing should feel connected',
    text: 'The best marketing system is the one you can actually keep using. One place for the work, one view of what happened, and one clear next action. That is the point of Nitro.\n\nStart free: nitrooutreach.com\n\n#marketingtools #businessgrowth #nitrooutreach',
    mediaUrl: 'https://nitrooutreach.com/icons/icon-512.png',
  },
];
