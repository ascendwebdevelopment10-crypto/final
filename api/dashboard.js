export default function handler(req, res) {
  ...
  const repliesHtml = '<div class="page" id="page-replies"><div class="rph"><h2>Replies <span id="rtc" style="color:#94a3b8;font-size:16px;font-weight:400"></span></h2><button class="rfbtn" id="refresh-btn">&#8635; Refresh</button></div><div class="subtabs"><button class="stab email-stab active" data-subtab="email">&#9993; Email Replies<span class="sbadge" id="er-badge">0</span></button><button class="stab sms-stab" data-subtab="sms">&#128241; SMS Replies<span class="sbadge" id="sr-badge">0</span></button></div><div class="subpage active" id="subpage-email"><div class="reply-list" id="email-list"></div></div><div class="subpage" id="subpage-sms"><div class="reply-list" id="sms-list"></div></div></div>';
