export default function handler(req, res) {
  const css = '*{margin:0;padding:0;box-sizing:border-box}body{font-family:-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;background:#0f172a;color:#e2e8f0;min-height:100vh}.header{background:#1e293b;border-bottom:1px solid #334155;padding:16px 32px;display:flex;align-items:center;justify-content:space-between}.header h1{font-size:20px;font-weight:700;color:#f8fafc}.badge-live{background:#22c55e;color:#fff;font-size:11px;padding:2px 8px;border-radius:99px;font-weight:600}.nav{background:#1e293b;border-bottom:1px solid #334155;padding:0 32px;display:flex;gap:4px}.nav-btn{padding:14px 20px;background:transparent;border:none;border-bottom:2px solid transparent;color:#94a3b8;cursor:pointer;font-size:14px;font-weight:500;transition:all .15s}.nav-btn:hover{color:#e2e8f0}.nav-btn.active{color:#6366f1;border-bottom-color:#6366f1}.nav-btn.replies-btn.active{color:#f59e0b;border-bottom-color:#f59e0b}.rbadge{display:none;background:#f59e0b;color:#fff;font-size:10px;padding:1px 6px;border-radius:99px;margin-left:6px;font-weight:600}.container{max-width:1200px;margin:0 auto;padding:32px}.page{display:none}.page.active{display:block}.stats-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:16px;margin-bottom:32px}.stat-card{background:#1e293b;border:1px solid #334155;border-radius:12px;padding:20px}.stat-card .label{font-size:12px;color:#94a3b8;margin-bottom:8px;text-transform:uppercase;letter-spacing:.05em}.stat-card .value{font-size:32px;font-weight:700;color:#f8fafc}.stat-card .sub{font-size:12px;color:#64748b;margin-top:4px}.stat-card.ec{border-top:3px solid #6366f1}.stat-card.sc{border-top:3px solid #f59e0b}.stat-card.rc{border-top:3px solid #22c55e}.stat-card.uc{border-top:3px solid #ef4444}.section{background:#1e293b;border:1px solid #334155;border-radius:12px;padding:24px;margin-bottom:24px}.section h2{font-size:16px;font-weight:600;margin-bottom:20px;color:#f8fafc}.chart{display:flex;align-items:flex-end;gap:4px;height:120px}.bg{flex:1;display:flex;gap:2px;align-items:flex-end;height:100%}.bar{flex:1;border-radius:2px 2px 0 0;min-height:2px}.eb{background:#6366f1}.sb{background:#f59e0b}.chart-labels{display:flex;gap:4px;margin-top:4px}.cl{flex:1;text-align:center;font-size:9px;color:#475569;overflow:hidden}.legend{display:flex;gap:16px;margin-top:12px}.li{display:flex;align-items:center;gap:6px;font-size:12px;color:#94a3b8}.ld{width:10px;height:10px;border-radius:2px}table{width:100%;border-collapse:collapse;font-size:13px}th{text-align:left;padding:10px 12px;color:#64748b;font-weight:500;border-bottom:1px solid #334155;font-size:11px;text-transform:uppercase}td{padding:12px;border-bottom:1px solid #1e293b;color:#cbd5e1;vertical-align:top}tr:last-child td{border-bottom:none}.bs{background:#1d4ed8;color:#bfdbfe;padding:2px 8px;border-radius:99px;font-size:11px}.br{background:#166534;color:#bbf7d0;padding:2px 8px;border-radius:99px;font-size:11px}.bsm{background:#92400e;color:#fde68a;padding:2px 8px;border-radius:99px;font-size:11px}.empty{text-align:center;color:#475569;padding:40px}.subtabs{display:flex;gap:8px;margin-bottom:24px;border-bottom:1px solid #334155;padding-bottom:0}.stab{padding:10px 20px;background:transparent;border:none;border-bottom:2px solid transparent;color:#94a3b8;cursor:pointer;font-size:14px;font-weight:500;margin-bottom:-1px}.stab.email-stab.active{color:#6366f1;border-bottom-color:#6366f1}.stab.sms-stab.active{color:#f59e0b;border-bottom-color:#f59e0b}.sbadge{display:inline-block;font-size:10px;padding:1px 6px;border-radius:99px;margin-left:6px;font-weight:600}.email-stab .sbadge{background:#1d4ed8;color:#bfdbfe}.sms-stab .sbadge{background:#92400e;color:#fde68a}.subpage{display:none}.subpage.active{display:block}.reply-list{display:flex;flex-direction:column;gap:12px}.rc2{background:#0f172a;border:1px solid #334155;border-radius:12px;overflow:hidden;transition:border-color .15s}.rc2:hover{border-color:#475569}.rc2.open{border-color:#f59e0b}.rc2.email-reply.open{border-color:#6366f1}.rh{padding:16px 20px;display:flex;align-items:center;gap:12px;cursor:pointer;user-select:none}.ra{width:38px;height:38px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:14px;color:#fff;flex-shrink:0}.ra.email-av{background:linear-gradient(135deg,#6366f1,#818cf8)}.ra.sms-av{background:linear-gradient(135deg,#f59e0b,#fbbf24)}.rm{flex:1;min-width:0}.rf{font-weight:600;color:#f8fafc;font-size:14px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.rs{color:#94a3b8;font-size:12px;margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.rt{font-size:11px;color:#64748b;flex-shrink:0}.rv{color:#64748b;font-size:18px;flex-shrink:0;transition:transform .2s}.rc2.open .rv{transform:rotate(90deg)}.rb2{display:none;padding:0 20px 20px;border-top:1px solid #1e293b}.rc2.open .rb2{display:block}.rbi{background:#1e293b;border-radius:8px;padding:16px;margin-top:16px;font-size:13px;line-height:1.7;color:#cbd5e1;white-space:pre-wrap;word-break:break-word;max-height:400px;overflow-y:auto}.ract{display:flex;gap:8px;margin-top:12px}.btn-r{padding:7px 14px;border-radius:8px;font-size:12px;font-weight:600;text-decoration:none;background:#6366f1;color:#fff;display:inline-block}.btn-sms-r{background:#f59e0b;color:#0f172a}.no-rep{text-align:center;padding:60px 20px}.no-rep .icon{font-size:48px;margin-bottom:16px}.no-rep p{color:#64748b;font-size:15px}.rph{display:flex;align-items:center;justify-content:space-between;margin-bottom:20px}.rph h2{font-size:20px;font-weight:700;color:#f8fafc}.rfbtn{padding:8px 14px;background:#1e293b;border:1px solid #334155;border-radius:8px;color:#94a3b8;cursor:pointer;font-size:12px}';
...
function le(){
  fetch('/api/logs?type=emails&limit=100').then(function(r){return r.json();}).then(function(emails){
    ...
    document.getElementById('email-tbody').innerHTML=emails.length
      ?emails.map(function(e){return '<tr><td>'+esc(e.to||'-')+'</td><td>'+esc(e.subject||'-')+'</td><td>'+(sl[e.segment]||e.segment||'-')+'</td><td>'+fmt(e.timestamp)+'</td><td><span class="'+(e.replied?'br':'bs')+'">'+(e.replied?'Replied':'Sent')+'</span></td></tr>';}).join('')
...
function ls(){
  fetch('/api/logs?type=sms&limit=100').then(function(r){return r.json();}).then(function(sms){
    ...
    document.getElementById('sms-tbody').innerHTML=sms.length
      ?sms.map(function(e){return '<tr><td>'+esc(e.to||'-')+'</td><td>'+esc((e.body||'-').substring(0,100))+'</td><td>'+(sl[e.segment]||e.segment||'-')+'</td><td>'+fmt(e.timestamp)+'</td><td><span class="'+(e.replied?'br':'bsm')+'">'+(e.replied?'Replied':'Sent')+'</span></td></tr>';}).join('')
