...
body:before,body:after{content:'';position:fixed;width:520px;height:520px;border-radius:44% 56% 62% 38%/46% 38% 62% 54%;filter:blur(72px);pointer-events:none;opacity:.2;animation:liquidFloat 14s ease-in-out infinite alternate}body:before{left:-180px;top:-160px;background:linear-gradient(135deg,#660b04,#660b04)}body:after{right:-220px;bottom:-190px;background:linear-gradient(135deg,#660b04,#660b04);animation-delay:-7s}@keyframes liquidFloat{to{transform:translate3d(70px,45px,0) rotate(24deg);border-radius:62% 38% 42% 58%/38% 59% 41% 62%}}
.card{position:relative;background:linear-gradient(145deg,rgba(34,37,35,.7),rgba(28,15,6,.54));border:1px solid rgba(102,11,4,.2);border-top-color:rgba(102,11,4,.75);border-radius:22px;padding:38px 34px 30px;width:min(390px,calc(100vw - 32px));text-align:left;box-shadow:0 32px 100px rgba(0,0,0,.54),inset 0 1px 0 rgba(255,255,255,.11),inset 0 -1px 0 rgba(102,11,4,.08);backdrop-filter:blur(26px) saturate(155%);-webkit-backdrop-filter:blur(26px) saturate(155%);overflow:hidden}
.card:before{content:'';position:absolute;inset:-1px;border-radius:inherit;background:linear-gradient(125deg,rgba(255,255,255,.12),transparent 28%,transparent 70%,rgba(102,11,4,.08));pointer-events:none}
...
input:focus{outline:none;border-color:#660b04;box-shadow:0 0 0 3px rgba(102,11,4,.1)}
button{width:100%;background:linear-gradient(120deg,#660b04,#660b04 52%,#660b04);color:#eb9255;border:1px solid rgba(255,255,255,.28);border-radius:10px;padding:13px;font-size:14px;font-weight:700;cursor:pointer;font-family:inherit;letter-spacing:0;box-shadow:0 10px 30px rgba(102,11,4,.2),inset 0 1px 0 rgba(255,255,255,.45)}
