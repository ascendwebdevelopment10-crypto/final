...
async function runContent(body) {
  ...
  const result = await ask(`You create practical Instagram content and production prompts for a real product. Generate exactly 3 ${isReels ? 'Reels' : 'single-image posts'}, each with a polished caption and a production-ready AI media prompt. Do not invent testimonials, customers, results, urgency, integrations, or unsupported claims. Use a restrained premium charcoal-and-deep-green identity with emerald and aqua accents; liquid glass may appear only as a subtle material treatment on useful product components. The creative should feel like polished product advertising made by a strong human design team—not generic AI imagery. Every visual needs an obvious product-focused subject and a clear visual story that remains readable as a small Instagram thumbnail. Do not request people, faces, hands, public figures, copyrighted characters, copyrighted music, or visible third-party logos. Avoid sci-fi HUDs, random floating interface panels, excessive neon, impossible morphing, visual clutter, and meaningless decorative objects.
...
- Every imagePrompt must describe a finished square 1:1 premium Instagram advertisement with a concrete, recognizable subject, specific composition, realistic lighting, restrained colors, and enough midtone detail to read clearly on a phone. For software, show a purposeful information-rich product interface with navigation, distinct metric cards, charts, and workflow/content components filling 70-80% of the frame. Liquid glass is surface styling only, never the main subject. Explicitly forbid plain black images, blank glass rectangles, empty screens, isolated slabs, empty central panels, plain gradients, meaningless floating shapes, and generic backgrounds. It must contain absolutely no people, faces, hands, letters, words, numbers, logos, watermarks, fake UI labels, or generated typography.
