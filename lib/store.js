...
export async function logEmail({ to, subject, body, contactName, contactId, timestamp, segment, service, id, providerId, status, businessLocation, businessWebsite, industry, targetSegment }) {
