export const CUSTOMER_PLANS = {
  ...
  growth: {
    ...
    features: ['Everything in Starter', '150 AI generations / month', '10 websites', 'Automated email sending & scheduling', 'Automated text sending & scheduling', 'Ad campaign management', 'Analytics dashboard', 'Priority email support'],
  },
  pro: {
